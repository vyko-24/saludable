...
export default function EditGr(props) {
  ...
  useEffect(() => {
      const initialChecked = usuarios.reduce((acc, usuarios) => {
        acc[usuarios.id] = params.selectedGroup.supervisor.some((user) => user.username === usuarios.username);
        return acc;
      }, {});
      setChecked(initialChecked);
  }, [usuarios, params.selectedGroup]);
  ...
  const formik = useFormik({
    initialValues: {
      id: params.selectedGroup.id,
      nombre: params.selectedGroup.nombre,
      supervisor: params.selectedGroup.supervisor.map((supe) => supe.id),
    },
